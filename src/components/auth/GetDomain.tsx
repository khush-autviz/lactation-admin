  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-100 ">
      ...
      <div className=" rounded-2xl w-1/3 bg-white">
        <ComponentCard title="Lactation" desc="Enter the email of the registered account.">
                    ...
                    <Table>
                      ...
                      <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                        {domain.map((item :any, index) => (
                          <div onClick={() => handleDomain(item.domain)}>
                          <TableRow key={index}>
                            <TableCell className="px-5 py-4 sm:px-6 text-start">
                              {item.name}
                            </TableCell>
                            <TableCell  className="px-5 py-4 sm:px-6 text-start text-green-400">
                              {item.domain}
                            </TableCell>
                          </TableRow>
                          </div>
